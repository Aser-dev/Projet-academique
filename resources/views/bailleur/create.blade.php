...
<div class="max-w-3xl px-4 py-10 mx-auto sm:px-6 lg:px-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold">Publier une annonce</h1>
    ...
    <form method="POST" action="{{ route('bailleur.properties.store') }}" enctype="multipart/form-data" class="space-y-5">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="location" value="{{ old('location') }}" required class="w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500">
        </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <select name="option" required class="w-full border-gray-300 rounded-xl focus:border-blue-500 focus:ring-blue-500">
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            <a href="{{ route('bailleur.properties') }}" class="px-6 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-semibold hover:bg-gray-50 transition-all">
                Annuler
            </a>
        </div>
    </form>
